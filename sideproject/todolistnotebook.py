...
BG_COLOR = "#252526"  # Darker background
FG_COLOR = "#D4D4D4"  # Light gray text
ENTRY_BG = "#3F3F46"  # Slightly lighter than BG
ENTRY_FG = "#D4D4D4"  # Light gray text
BUTTON_BG = "#303031"  # Darker button background
BUTTON_FG = "#D4D4D4"  # Light gray text
ACCENT_COLOR = "#666666"  # Dark gray accent color for focus/active states
...
TODO_AUTOSAVE_FILE = "todo_autosave.json"
...
def on_app_close(root, notebook_app, hour_entries, todo_entries, completed_vars):
    ...
    try:
        with open(TODO_AUTOSAVE_FILE, "w") as f:
...
def load_todo_data(hour_entries, todo_entries, completed_vars):
    try:
        with open(TODO_AUTOSAVE_FILE, "r") as f:
